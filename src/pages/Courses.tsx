...
const courseList = [
	{
		...
		description:
			'Build a strong foundation in IT concepts, computer basics, and essential digital skills for all fields.',
		icon: '💻',
	},
	{
		title: 'Internet Technology and Web Designing',
		description:
			'Learn how the internet works and create attractive, responsive websites using modern web technologies.',
		icon: '🌐',
	},
	{
		title: 'Financial Accounting Using Tally & Personality Development',
		description:
			'Master Tally for accounting and enhance your communication and professional skills for the workplace.',
		icon: '📊',
	},
	{
		title: 'Emerging Trends in IT',
		description:
			'Stay updated with the latest advancements and innovations shaping the future of information technology.',
		icon: '🚀',
	},
	{
		title: 'Multilingual DTP',
		description:
			'Design and publish documents in multiple languages using advanced desktop publishing tools.',
		icon: '📝',
	},
	{
		title: 'Artificial Intelligence and Machine Learning Python',
		description:
			'Explore AI and ML concepts and get hands-on experience with Python for real-world applications.',
		icon: '🤖',
	},
	{
		title: 'Practical & Project Work',
		description:
			'Apply your knowledge through practical assignments and projects to build confidence and expertise.',
		icon: '📁',
	},
];
