const About: React.FC = () => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-white px-2 py-6 sm:py-10">
    <main className="w-full max-w-5xl mx-auto flex flex-col justify-center items-center min-h-screen">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-purple-700 text-center mb-8 sm:mb-10">
        About Us
      </h1>
      <p className="text-base sm:text-lg md:text-xl text-black text-center font-semibold mb-8 sm:mb-12 max-w-4xl">
      ...
      <section className="mb-8 sm:mb-12 w-full">
        <h2 className="text-lg sm:text-xl font-bold text-purple-800 mb-3 sm:mb-4 text-center">Our Vision</h2>
        <p className="text-sm sm:text-base text-black font-medium text-center">
      ...
      <section className="mb-8 sm:mb-12 w-full">
        <h2 className="text-lg sm:text-xl font-bold text-purple-800 mb-3 sm:mb-4 text-center">Accreditations & Affiliations</h2>
        <ul className="list-disc list-inside text-sm sm:text-base text-black font-medium space-y-2 max-w-2xl mx-auto">
      ...
      <section className="mb-8 sm:mb-12 w-full">
        <h2 className="text-lg sm:text-xl font-bold text-purple-800 mb-3 sm:mb-4 text-center">What Sets Us Apart?</h2>
        <ul className="list-disc list-inside text-sm sm:text-base text-black font-medium space-y-2 max-w-2xl mx-auto">
      ...
      <section className="mb-8 sm:mb-12 w-full">
        <h2 className="text-lg sm:text-xl font-bold text-purple-800 mb-3 sm:mb-4 text-center">Our Achievements</h2>
        <p className="text-sm sm:text-base text-black font-medium text-center mb-3">
        ...
        <p className="text-sm sm:text-base text-black font-medium text-center mt-3">
      ...
      <section className="mb-8 sm:mb-12 w-full">
        <h2 className="text-lg sm:text-xl font-bold text-purple-800 mb-3 sm:mb-4 text-center">Join the Revolution</h2>
        <p className="text-sm sm:text-base text-black font-medium text-center">
